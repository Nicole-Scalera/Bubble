...
Branching is an essential concept for the developer-side of things; namely, anyone working with the game's project files. For Writers and Artists, you can ignore this section and focus on committing to the main branch (check out [Uploading to the Assets folder](https://github.com/Nicole-Scalera/Bubble/blob/main/02%20Docs/01%20Information/uploading-to-assets.md)).
